    ...
    return (
        ...
        <div className='explore-menu' id='explore-menu'>
            ...
            <div className="offer-line">
                <p> Offer Offer Place order and get FREE DELIVERY ! Using this code: <span className="promo-code">PJK840</span></p>
            </div>
                ...
                {menu_list.map((item, index) => {
                    return (
                        <div onClick={() => setCategory(prev => prev === item.menu_name
                            ? "All" : item.menu_name)} key={index} className='explore-menu-list-item' style={{ "--i": index }}>
